...
packages = [
  { url: 'https://github.com/airsidemobile/JOSESwift',    version: '2.4.0', product: 'JOSESwift' },
  { url: 'https://github.com/square/Valet',               version: '4.2.0', product: 'Valet'     },
  { url: 'https://github.com/apple/swift-certificates',   version: '1.0.0', product: 'X509'      },
]
