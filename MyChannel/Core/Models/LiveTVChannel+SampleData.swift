...
extension LiveTVChannel {
    ...
    // PERFORMANCE: Split into 2 chunks — Swift type-checker handles
    // small array literals MUCH faster than one giant 1300-line one.
    static var fireChannels: [LiveTVChannel] {
        _fireChannels_a + _fireChannels_b
    }
    static let _fireChannels_a: [LiveTVChannel] = [
