...
class LiveStreamMonitorService: ObservableObject {
    ...
    func refreshMetrics() async {
        ...
        struct RawS: Decodable { let id: String; let streamId: String; let creatorId: String; let creatorName: String; let viewerCount: Int; let bitrate: Double; let latency: Double; let frameRate: Double; let droppedFrames: Int; let healthScore: Double; let startedAt: String; let isRecording: Bool; let thumbnailURL: String? }
