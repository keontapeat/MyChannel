// ⚡ PERFORMANCE: Extracted from GamingAIOrchestrator.swift — independent compilation unit.
// All result types, supporting types, AI agent sub-structs, and Cloud response types.
import Foundation
