...
private struct CIAStatTile: View {
...
private struct CIAActionTile: View {
...
private struct CIACategoryChip: View {
...
private struct PatentStatPill: View {
    let label: String
    let value: String
    let color: Color
    var body: some View {
...
private struct PatentItemCard: View {
    let item: PatentItem
