...
struct OnboardingView: View {
    ...
    var body: some View {
        // Immediately complete onboarding and dismiss - we don't want this flow anymore
        Color.clear
            .onAppear {
...
struct OnboardingPage: Identifiable, Hashable {
    ...
    static let sample: [OnboardingPage] = [
        ...
        .init(title: "Watch your way", subtitle: "Flicks, long-form, live—seamless and smooth.", systemImage: "play.rectangle.fill", gradient: [Color.purple, Color.pink]),
