...
packages = [
  { url: 'https://github.com/MacPaw/OpenAI',             version: '0.2.9', product: 'OpenAI'       },
  { url: 'https://github.com/Alamofire/Alamofire',        version: '5.9.1', product: 'Alamofire'    },
  { url: 'https://github.com/apple/swift-log',            version: '1.5.4', product: 'Logging'      },
  { url: 'https://github.com/SwiftyBeaver/SwiftyBeaver',  version: '2.1.1', product: 'SwiftyBeaver' },
]
